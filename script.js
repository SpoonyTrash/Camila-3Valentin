...
document.getElementById('siBtn').addEventListener('click', function() {
  ...
  audio.play();
    ...
    document.getElementById('messageContainer').innerHTML = 'Feliz San Valentin mi florecita <3';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'Tomate tu tiempo para pensarlo';
            document.getElementById('noBtn').style.backgroundColor = '#FFADAD';
        ...
        case 8:
            ...
            document.getElementById('noBtn').innerHTML = 'y me haré popó';
            document.getElementById('noBtn').style.backgroundColor = '#FFADAD';
        ...
        case 9:
            ...
            document.getElementById('noBtn').innerHTML = 'Estaré muy triste y me haré popó';
            document.getElementById('noBtn').style.backgroundColor = '#FFADAD';
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'Florecita... :(';
            document.getElementById('noBtn').style.backgroundColor = '#FFADAD';
        ...
        case 12:
            ...
            document.getElementById('noBtn').innerHTML = 'Me estoy poniendo triste ';
            document.getElementById('noBtn').style.backgroundColor = '#FFADAD';
        ...
        case 13:
            ...
            document.getElementById('noBtn').innerHTML = 'Me estás rompiendo el corazón :(';
            document.getElementById('noBtn').style.backgroundColor = '#FFADAD';
